...
class DocAttach extends \common\models\GenericWeb {
    ...
    public function rules() {
        return [
            ...
            [['file'], 'file', 'extensions' => 'pdf', 'wrongExtension' => 'PDF file only', 'on' => 'updateResume'],
            [['file'], 'file', 'extensions' => ['jpg','png','jpeg'], 'wrongExtension' => 'JPG, JPEG or PNG file only', 'on' => 'updateProfilePic'],
